...
public class PartyData {
    ...
    // constructors
    public PartyData(int id, String date, String time, String theme, float budget, int guest) {
        this.id = id;
        this.date = date;
        this.time = time;
        this.theme = theme;
    ...
    public PartyData(Context context) {
    }

    public PartyData(ContentValues values) {
    }
    //
